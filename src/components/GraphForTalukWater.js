...
import GraphWaterComponent from './GraphWaterComponent'
...
export default class GraphForTalukWater extends Component {
    constructor(props) {
        super(props)
        this.state = {
            stateName: "",
    ...
    render() {
        return (
            <div>
                ...
                <div>
                    <h1 id="headertextforcomponent">Distribution of Area under irrigation by types</h1>
                </div>
                ...
                <div id="rendercomponent">{this.state.isReady ? <GraphWaterComponent AreaId={this.state.talukName} /> : ''}</div>
            </div >
